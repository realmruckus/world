...
| CI 覆盖 | `.github/workflows/life-engine-tests.yml` | 对应本地命令已通过；远端 CI 推送后核验 | 待远端 | RR-119 tests + 10,000 Simulation step |
...
- 远端 GitHub Actions 与 Vercel：只有推送 Draft PR 后才能取得最终状态。
